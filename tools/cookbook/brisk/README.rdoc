...
The main attributes to look can be found at $CHEF_HOME/attributes/default.rb and are:
...
After following the instructions here: http://wiki.opscode.com/display/chef/Quick+Start.
...
NOTE: You can run these lines more times as long as the attributes are set properly. Also, these lines should be run consecutively and never parallel.
