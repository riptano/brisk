...
mkdir -p %{buildroot}/usr/share/brisk-demos/pig
...
cp -p demos/pig/files/example.txt %{buildroot}/usr/share/brisk-demos/pig
cp -p demos/pig/push-to-cf.pig %{buildroot}/usr/share/brisk-demos/pig
cp -p demos/pig/sort-by-total-cfs.pig %{buildroot}/usr/share/brisk-demos/pig
cp -p demos/pig/sort-by-total-cs.pig %{buildroot}/usr/share/brisk-demos/pig
